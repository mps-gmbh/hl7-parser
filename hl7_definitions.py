...
segment_maps = {
    ...
    'PID': [
        ...
        make_cell_type('race', options = {"required": True}),
        make_cell_type('patient_address', options = {"required": True}),
        ...
        make_cell_type('ethnic_group', options = {"required": True}),
        make_cell_type('birth_place'),
        make_cell_type('multiple_birth_indicator'),
        make_cell_type('birth_order'),
        make_cell_type('citizenship', options = {"required": True}),
        ...
        make_cell_type('identity_reliability_code', options = {"required": True}),
